...
```{r}
Anscombe <- read.csv("~/Documents/GitHub/Data_Science/R_Scripts_and_Projects/Correlation_regression/Anscombe.txt", sep="")
glimpse(Anscombe)
```
...
When transforming for log, the correlaiton coefficient increases.
